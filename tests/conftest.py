...
def wait_for_support_sync(
    ...
    retry_count = 60
    krakow_client = OnedataFileRESTClient(
        onezone_ip, onezone_admin_token, [oneprovider_krakow_ip], verify_ssl=False
    )
    paris_client = OnedataFileRESTClient(
        onezone_ip, onezone_admin_token, [oneprovider_paris_ip], verify_ssl=False
    )
